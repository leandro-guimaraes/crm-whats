      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Crie fluxos de trabalho que respondem automaticamente a eventos do WhatsApp®.  
          </p>
        </div>
        <GatedButton
          canAct={canCreate}
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <span className="text-foreground">{pendingDelete?.name}</span> e seu histórico
              de execução. Isso não pode ser desfeito.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
